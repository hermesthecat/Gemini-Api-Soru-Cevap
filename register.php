...
?>
    ...
    <!-- Notification Toast -->
    <div id="notification-toast" class="fixed top-4 right-4 max-w-xs bg-white dark:bg-gray-800 border-l-4 border-green-500 text-gray-900 dark:text-gray-100 p-4 rounded-lg shadow-lg transform translate-x-full transition-transform duration-300 z-50">
        <div class="flex">
